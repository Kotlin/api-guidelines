...
For example, in the coroutine Flows API both [buffering and conflation](coroutines-flow-operators.md#concurrent-processing-operators) are implemented as separate functions.
