...
To streamline artifact production, use [cross-compilation](https://www.jetbrains.com/help/kotlin-multiplatform-dev/multiplatform-publish-lib-setup.html#host-requirements) to publish Kotlin Multiplatform libraries from any host.
